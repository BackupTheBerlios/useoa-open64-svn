      subroutine g$tran$204(g$p$, n, m, xr, g$xr, ldg$xr, xth, g$xth, ld
     *g$xth, yr, yth, ajac, g$ajac, ldg$ajac)
C       
...
c        real g$ajac(ldg$ajac)
c        real g$xth(ldg$xth)
c        real g$xr(ldg$xr)
        double precision g$ajac(ldg$ajac)
